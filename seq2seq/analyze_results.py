...
def main(args):
    ...
    eval_metric = f1_subtokens if args.task == "func" else nltk_sentence_bleu
    ...
    if args.data_folder_control:
        ...
        control_dup = [eval_metric(p, r) for p, r in zip(predictions_dup_control, references_dup_control)]
        control_no_dup = [eval_metric(p, r) for p, r in zip(predictions_no_dup_control, references_no_dup_control)]
