...
do
  ...
  python train.py \
    ...
    --target_column "cs" \
    --output_dir "$path/codetrans/seed_$seed/random_unbiased_lora" \
  ...
  python generate_predictions.py \
    --checkpoint "$path/codetrans/seed_$seed/random_unbiased_lora/best_checkpoint" \
