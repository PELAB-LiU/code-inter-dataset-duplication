...
do
  echo "Seed: $seed"
  echo "unbiased codetrans prefix"
  python train.py \
    ...
    --target_column "cs" \
    --output_dir "$path/codetrans/seed_$seed/random_unbiased_prefix" \
  ...
  python generate_predictions.py \
    --checkpoint "$path/codetrans/seed_$seed/random_unbiased_prefix/best_checkpoint" \
