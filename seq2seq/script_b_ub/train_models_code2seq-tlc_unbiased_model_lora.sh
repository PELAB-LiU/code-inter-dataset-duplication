...
do
  echo "Seed: $seed"
  echo "antolin/csn-small-unbiased-random-encoder-decoder-20"
  echo "tlc unbiased lora"
  python train.py \
    ...
    --is_split_source \
    --target_column "nl" \
    --output_dir "$path/code2text_tlc/seed_$seed/random_unbiased_lora" \
    --num_train_epochs 5 \
  ...
  python generate_predictions.py \
    --checkpoint "$path/code2text_tlc/seed_$seed/random_unbiased_lora/best_checkpoint" \
