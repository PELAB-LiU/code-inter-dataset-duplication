...
do
  ...
  python train.py \
    ...
    --target_column "cs" \
    --output_dir "$path/codetrans/seed_$seed/random_unbiased_l66" \
  ...
  python generate_predictions.py \
    --checkpoint "$path/codetrans/seed_$seed/random_unbiased_l66/best_checkpoint" \
