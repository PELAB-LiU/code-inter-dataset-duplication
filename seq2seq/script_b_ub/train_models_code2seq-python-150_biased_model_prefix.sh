...
do
  ...
  python train.py \
    ...
    --is_split_source \
    --target_column "nl" \
    --output_dir "$path/code2text/seed_$seed/random_biased_prefix" \
    --num_train_epochs 5 \
  ...
  python generate_predictions.py \
    --checkpoint "$path/code2text/seed_$seed/random_biased_prefix/best_checkpoint" \
