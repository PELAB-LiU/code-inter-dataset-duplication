...
for seed in "${seeds[@]}";
do
  echo "l33 unbiased python-150 Seed: $seed"
  echo "antolin/csn-small-unbiased-random-encoder-decoder-20-l33"
  python train.py \
    ...
    --is_split_source \
    --target_column "nl" \
    --output_dir "$path/code2text/seed_$seed/random_unbiased_l33" \
    --num_train_epochs 10 \
  ...
  python generate_predictions.py \
    --checkpoint "$path/code2text/seed_$seed/random_unbiased_l33/best_checkpoint" \
