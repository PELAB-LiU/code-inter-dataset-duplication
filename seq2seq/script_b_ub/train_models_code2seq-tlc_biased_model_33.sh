...
do
  ...
  python train.py \
    ...
    --is_split_source \
    --target_column "nl" \
    --output_dir "$path/code2text_tlc/seed_$seed/random_biased_l33" \
    --num_train_epochs 10 \
  ...
  python generate_predictions.py \
    --checkpoint "$path/code2text_tlc/seed_$seed/random_biased_l33/best_checkpoint" \
