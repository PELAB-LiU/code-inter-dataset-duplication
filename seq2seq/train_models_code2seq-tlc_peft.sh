...
do
  ...
  python train.py \
    ...
    --is_split_source \
    --target_column "nl" \
    --output_dir "$path/code2text_tlc/seed_$seed/codet5large_lora" \
    --num_train_epochs 5 \
  ...
  python generate_predictions.py \
    --checkpoint "$path/code2text_tlc/seed_$seed/codet5large_lora/best_checkpoint" \
  ...
  python train.py \
    ...
    --is_split_source \
    --target_column "nl" \
    --output_dir "$path/code2text_tlc/seed_$seed/codet5large_prefix" \
    --num_train_epochs 5 \
    --max_length_source 256 \
    --max_length_target 128 \
    --patience 3 \
  ...
  python generate_predictions.py \
    --checkpoint "$path/code2text_tlc/seed_$seed/codet5large_prefix/best_checkpoint" \
    --tokenizer_source "Salesforce/codet5-large" \
    --tokenizer_target "Salesforce/codet5-large" \
    --data_path_hf "antolin/tlc_interduplication" \
    --source_column "tokens" \
