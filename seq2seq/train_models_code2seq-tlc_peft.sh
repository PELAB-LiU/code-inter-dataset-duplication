...
do
  ...
  python train.py \
    ...
    --is_split_source \
    --target_column "nl" \
    --output_dir "code2text_tlc/seed_$seed/codet5_lora" \
    --num_train_epochs 10 \
  ...
  python generate_predictions.py \
    --checkpoint "code2text_tlc/seed_$seed/codet5_lora/best_checkpoint" \
  ...
  python train.py \
    ...
    --is_split_source \
    --target_column "nl" \
    --output_dir "code2text_tlc/seed_$seed/codet5_prefix" \
    --num_train_epochs 10 \
    --max_length_source 256 \
  ...
  python generate_predictions.py \
    --checkpoint "code2text_tlc/seed_$seed/codet5_prefix/best_checkpoint" \
    --base_model "Salesforce/codet5-base" \
    --tokenizer_source "Salesforce/codet5-base" \
    --tokenizer_target "Salesforce/codet5-base" \
    --data_path_hf "antolin/tlc_interduplication" \
